		...
		<div class='footer_txt'>
			<?php
				...
				<?php /* 
					...
					You can buy this theme without footer links online at http://smthemes.com/buy/hellfire/
				*/ ?>
				<div class='smthemes'>Designed by <a href='http://premiumfreewordpressthemes.com/category/games/' target='_blank'>Wordpress Free Game Themes</a>, thanks to: <a href='http://lojasony.net/' target='_blank'>Sony Games</a>, <a href='http://smnnews.com' target='_blank'>SMNnews Hard Metal</a> and <a href='http://topshowsontv.com/' target='_blank'>Top TV and Games</a></div>
		</div>
		</div>
<?php wp_footer(); ?>
</div>
