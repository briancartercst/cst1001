        	...
        	<?php
				...
				foreach($posts as $p) {?>
                    <li>
                        ...
                        <?php if ( $instance['display_title'] ) { ?> <a href="<?php echo get_permalink($p->ID); ?>" rel="bookmark" class="widget-title" title="<?php echo $p->post_title; ?>"><?php echo $p->post_title?></a><?php } ?>
